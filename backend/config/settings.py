...
config/settings.py
──────────────────
Main Django settings for MedAI backend.
...
# ── FastAPI ML Service ────────────────────────────────────────────────────────
FASTAPI_ML_URL = config('FASTAPI_ML_URL', default='http://localhost:8001')
...
# ── Email (Render SMTP or console in dev) ─────────────────────────────────────
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@medai.app')
