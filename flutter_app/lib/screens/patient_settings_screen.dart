...
class PatientSettingsScreen extends StatefulWidget {
  ...
  @override State<PatientSettingsScreen> createState() => _PatientSettingsScreenState();
}
    ...
    await showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 8),
          TextField(controller: _confPassCtrl, obscureText: true,
            ...
            onPressed: () async {
              ...
              try {
                await AuthService.changePassword(
                    oldPassword: _oldPassCtrl.text, newPassword: _newPassCtrl.text);
                if (!mounted) return;
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          ...
          Container(color: Colors.white,
            ...
            child: const Row(children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Settings', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppTheme.textDark)),
                Text('Manage your preferences', style: TextStyle(fontSize: 12, color: AppTheme.textGrey)),
              ]),
            ])),
          Padding(padding: const EdgeInsets.all(16), child: Column(children: [
              ...
              Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                    ...
                    child: const Text('Patient', style: TextStyle(color: AppTheme.primaryBlue, fontSize: 11, fontWeight: FontWeight.w600))),
                ])),
              ]),
            ])),
            ...
            // Notifications
            _sectionCard(title: 'Notifications', icon: Icons.notifications_outlined, iconColor: AppTheme.primaryBlue, children: [
              SettingsRow(title: 'Push Notifications', subtitle: 'Get alerts about your cases',
            ...
            // Security
            _sectionCard(title: 'Privacy & Security', icon: Icons.shield_outlined, iconColor: AppTheme.primaryGreen, children: [
              SettingsRow(title: 'Biometric Login', subtitle: 'Use fingerprint or face ID',
                  hasToggle: true, toggleValue: _biometricLogin,
                  onToggleChanged: (v) => setState(() => _biometricLogin = v)),
            ...
            // Preferences
            _sectionCard(title: 'Preferences', icon: Icons.tune, iconColor: AppTheme.primaryTeal, children: [
            ...
            Container(padding: const EdgeInsets.all(12),
              ...
              child: const Text('🔒 Your health data is encrypted. MedAI never sells your data.',
                  textAlign: TextAlign.center, style: TextStyle(fontSize: 11, color: AppTheme.textGrey))),
